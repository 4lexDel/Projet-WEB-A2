<?php
    ...
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom bg-white">
        ...
        <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
            <li><a href="#" class="nav-link px-4 link-secondary">Accueil</a></li>
            <li><a href="#" class="nav-link px-4 link-dark">Recherche de stage</a></li>
            <li><a href="#" class="nav-link px-4 link-dark">Mes candidatures</a></li>
        </ul>
        ...
        <div class="col-md-2 text-end">
            ...
            <form class="bi me-2" action="home.php" method="post">
                <a href="#"><img class="bi me-2" src="../assets\img\profil.jpg" alt="" width="60" height="60"></a>
