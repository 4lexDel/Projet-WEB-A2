...
if (isset($_GET["objet"])) {
    ...
    switch ($_GET["objet"]) {
        ...
        case "entreprise":
            ...
            for ($j = 0; $j < $nbRow; $j++) {
                echo '<div class="card">';
                echo '<div class="card-header" style="display:flex; justify-content:space-between;">';
                echo $data[$j]["sector"];
?>
                <button type="button" class="btn btn-outline-danger justify-content-left deleteButton">
