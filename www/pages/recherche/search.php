...
?>
        ...
        case "entreprise":
            ...
            for ($j = 0; $j < $nbRow; $j++) {
                ...
                <input type="hidden" name="note" value="" class="px-2 note" />
                ...
                <button data-objet="company" data-id=<?php echo $data[$j]["idCompany"] ?> type="button" class="btn btn-success justify-content-left evaluateButton mx-2">
